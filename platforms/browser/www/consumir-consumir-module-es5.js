    ...
    function srcAppConsumirConsumirPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ConsumirPage = /*#__PURE__*/function () {
        function ConsumirPage(bluetoothSerial, platform, cdr, toastController, router, actRoute, service, client, httpClient) {
          ...
          this.errores = [];
          if (localStorage.getItem('nombre')) this.cerveza = localStorage.getItem('nombre');
              ...
              if (_this.router.url == '/consumir' && _this.arreglo.length == 14) {
                switch (_this.arreglo[0]) {
                  ...
                  case '1':
                    ...
                    if (_this.arreglo[13] == '1') _this.precio = _this.arreglo[8]; //pico 1

                    if (_this.arreglo[13] == '2') _this.precio = _this.arreglo[9]; //pico 2 

                    if (_this.arreglo[13] == '1') _this.sensibilidad = _this.arreglo[11]; //pico 1

                    if (_this.arreglo[13] == '2') _this.sensibilidad = _this.arreglo[12]; //pico 2

                    if (_this.arreglo[13] == '1') {

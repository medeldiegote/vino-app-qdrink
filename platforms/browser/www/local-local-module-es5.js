(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["local-local-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppLocalLocalPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppLocalLocalRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LocalPageRoutingModule", function () {
        return LocalPageRoutingModule;
      });
      /* harmony import */
      ...
      var _local_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./local.page */
      ...
      var LocalPageRoutingModule = function LocalPageRoutingModule() {
        _classCallCheck(this, LocalPageRoutingModule);
      };

      LocalPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppLocalLocalModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LocalPageModule", function () {
      ...
      var _local_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./local-routing.module */
      "./src/app/local/local-routing.module.ts");
      /* harmony import */


      var _local_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./local.page */
      "./src/app/local/local.page.ts");

      var LocalPageModule = function LocalPageModule() {
        _classCallCheck(this, LocalPageModule);
      };

      LocalPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _local_routing_module__WEBPACK_IMPORTED_MODULE_5__["LocalPageRoutingModule"]],
    ...
    /***/
    function srcAppLocalLocalPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppLocalLocalPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LocalPage", function () {
        return LocalPage;
      });
      /* harmony import */
      ...
      var LocalPage = /*#__PURE__*/function () {
        function LocalPage(service, platform, cdr, router, actRoute, bluetoothSerial, toastController, keyboard) {
          var _this = this;
          ...
          this.inputCaracteristicas = ''; ///pico2
          ...
          if (localStorage.getItem('caracteristicas')) this.inputCaracteristicas = localStorage.getItem('caracteristicas');
          if (localStorage.getItem('nombre2')) this.nombre2 = localStorage.getItem('nombre2');
          if (localStorage.getItem('caracteristicas2')) this.inputCaracteristicas2 = localStorage.getItem('caracteristicas2');
          ...
          this.platform.ready().then(function () {
            _this.checkBlueroothEnable();

            if (localStorage.getItem('mac')) _this.mac_actual = JSON.parse(localStorage.getItem('mac')).name;
          });
        }

        _createClass(LocalPage, [{
          key: "checkBlueroothEnable",
          value: function checkBlueroothEnable() {
            var _this2 = this;
            ...
            this.bluetoothSerial.isEnabled().then(function (success) {
              ...
              _this2.presentToast("Por favor, activa el Bluetooth");
            });
          }
        }, {
          ...
          value: function listPairedDevices() {
            ...
            this.bluetoothSerial.list().then(function (success) {
              ...
              console.log(_this3.listPairedDevices);
            }, function (error) {
          ...
          key: "setMac",
          value: function setMac() {
            if (this.inputMac >= 0) {
              localStorage.setItem('mac', JSON.stringify(this.pairedList[this.inputMac]));
              console.log(this.inputMac);
              console.log(JSON.parse(localStorage.getItem('mac'))); //this.mac_actual = JSON.parse(localStorage.getItem('mac')).name
              //this.presentToast('Conectando')

              this.bluetoothSerial.disconnect();
              this.service.conectar();
            } else this.presentToast('Debe elegir box');
          }
        }, {
          key: "setNombre",
          value: function setNombre() {
          ...
          key: "setCaracteristicas",
          value: function setCaracteristicas() {
          ...
          key: "setCaracteristicas2",
          value: function setCaracteristicas2() {
          ...
          value: function optionsFn() {
            var nombre = this.nom.nombre;
            var caracteristicas = this.nom.caracteristicas;
            this.updateNombre.setValue({
              'newNombre': nombre
            });
            this.updateCaracteristicas.setValue({
              'newCaracteristicas': caracteristicas
            });
          }
        }, {
          key: "presentToast",
      ...
      LocalPage.ctorParameters = function () {
        return [{
      ...
      LocalPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-local',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./local.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/local/local.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./local.page.scss */
        "./src/app/local/local.page.scss"))["default"]]
      })], LocalPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=local-local-module-es5.js.map